...
1.  Abrir o arquivo `KurapikaSendMessage.js` ([Clique aqui para ver o código do script](KurapikaSendMessage.js) 
1.  Abrir o arquivo `SherekSendMessage.js` [Clique aqui para ver o código do script](SherekSendMessage.js)).
